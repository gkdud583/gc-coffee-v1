...
class ProductJdbcRepositoryTest {
	...
	private static Product newProduct = new Product(UUID.randomUUID(), "new-product.html", Category.COFFEE_BEAN_PACKAGE, 1000);
	...
	void testFindByCategory() {
		List<Product> category = repository.findByCategory(newProduct.getCategory());
